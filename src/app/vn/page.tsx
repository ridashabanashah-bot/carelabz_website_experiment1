...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("vn");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Vietnam",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, TCVN 7447 compliance, short circuit analysis, and power system engineering across Vietnam.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/vn/",
      languages: {
        "en-VN": "https://carelabz.com/vn/",
        "x-default": "https://carelabz.com/vn/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Vietnam — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, TCVN 7447 compliance, and power system engineering across Vietnam.",
      url: "https://carelabz.com/vn/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_VN",
    },
...
export default async function VNHomePage() {
  const page = await getHomePage("vn");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Vietnam",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Vietnam standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
