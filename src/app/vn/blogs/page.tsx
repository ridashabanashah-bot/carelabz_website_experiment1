...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Vietnam",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and TCVN 7447 compliance for Vietnam facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/vn/blogs/",
    languages: {
      "en-VN": "https://carelabz.com/vn/blogs/",
      "x-default": "https://carelabz.com/vn/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Vietnam",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Vietnam.",
    url: "https://carelabz.com/vn/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-VN", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function VNBlogIndexPage() {
  const allPosts = await getBlogPosts("vn");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/vn/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Vietnam",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Vietnam.",
      "en-VN"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/vn/" },
      { name: "Blog", url: "https://carelabz.com/vn/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of TCVN 7447, TCVN 7447, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Vietnam
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Vietnam facility meet
              TCVN 7447 and TCVN 7447 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/vn/services/arc-flash-study/"
