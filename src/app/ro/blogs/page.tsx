...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Romania",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and I7-2011 compliance for Romania facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/ro/blogs/",
    languages: {
      "en-RO": "https://carelabz.com/ro/blogs/",
      "x-default": "https://carelabz.com/ro/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Romania",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Romania.",
    url: "https://carelabz.com/ro/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-RO", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function ROBlogIndexPage() {
  const allPosts = await getBlogPosts("ro");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/ro/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Romania",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Romania.",
      "en-RO"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/ro/" },
      { name: "Blog", url: "https://carelabz.com/ro/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of I7-2011, I7-2011, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Romanian
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Romania facility meet
              I7-2011 and I7-2011 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/ro/services/arc-flash-study/"
