...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("ro");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Romania",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, I7-2011 compliance, short circuit analysis, and power system engineering across Romania.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/ro/",
      languages: {
        "en-RO": "https://carelabz.com/ro/",
        "x-default": "https://carelabz.com/ro/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Romania — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, I7-2011 compliance, and power system engineering across Romania.",
      url: "https://carelabz.com/ro/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_RO",
    },
...
export default async function ROHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Romania",
    },
  };
