...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: page?.metaTitle ?? "About Carelabs | Argentinan Electrical Safety Experts",
    description:
    ...
    openGraph: {
      ...
      description:
        page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Argentina.",
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            {page?.ctaBannerSubtext ? (
              ...
              <p className="text-white/70 text-lg mb-8">
                Ready to elevate your safety standards? Talk to our Argentinan experts today.
              </p>
            )}
            <Link
