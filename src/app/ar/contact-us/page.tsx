...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: page?.metaTitle ?? "Contact Carelabs Argentina | Get in Touch",
    description:
      page?.metaDescription ??
      "Contact the Carelabs team for electrical safety testing, arc flash studies, and AEA 90364 compliance services across Argentina.",
    alternates: {
      canonical: "https://carelabz.com/ar/contact-us/",
      languages: {
        "en-AR": "https://carelabz.com/ar/contact-us/",
        "x-default": "https://carelabz.com/ar/contact-us/",
      },
    },
    openGraph: {
...
export default async function ARContactPage() {
  ...
  const jsonLd = buildJsonLd([
    ...
    getBreadcrumbSchema([
      ...
      { name: "Contact", url: "https://carelabz.com/ar/contact-us/" },
    ]),
  ]);
                ...
                {page?.mapEmbedUrl && (
                  <div className="rounded-xl overflow-hidden border border-gray-200 mt-4">
                    <iframe
                      ...
                      title="Carelabs Argentina Office Location"
                    />
                  </div>
                )}
              </div>
