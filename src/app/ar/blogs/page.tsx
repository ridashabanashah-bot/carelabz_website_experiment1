...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Argentina",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and AEA 90364 compliance for Argentina facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/ar/blogs/",
    languages: {
      "en-AR": "https://carelabz.com/ar/blogs/",
      "x-default": "https://carelabz.com/ar/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Argentina",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Argentina.",
    url: "https://carelabz.com/ar/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-AR", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function ARBlogIndexPage() {
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/ar/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Argentina",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Argentina.",
      "en-AR"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/ar/" },
      { name: "Blog", url: "https://carelabz.com/ar/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of AEA 90364, AEA 90364, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Argentinan
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Argentina facility meet
              AEA 90364 and AEA 90364 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/ar/services/arc-flash-study/"
