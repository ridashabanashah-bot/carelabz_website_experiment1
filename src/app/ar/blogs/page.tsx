...
export const metadata: Metadata = {
  title:
    "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Argentina",
  description:
      ...
      <main id="main-content">
        ...
        >
          ...
          <div className="relative mx-auto max-w-4xl px-4 sm:px-8 text-center">
            ...
            >
              Stay ahead of AEA 90364, IRAM 2281, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help
              Argentina facilities stay safe and compliant.
            </p>
          </div>
        </section>
        ...
        >
          <div className="relative mx-auto max-w-4xl text-center">
            ...
            >
              ...
              AEA 90364 and IRAM 2281 requirements. Get a free consultation
              today.
            </p>
