...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title:
      page?.metaTitle ??
      "Carelabs — Electrical Safety & Power System Studies | Argentina",
    description:
    ...
    openGraph: {
      title:
        page?.metaTitle ??
        "Carelabs Argentina — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ??
        "IEEE 1584 arc flash studies, AEA 90364 compliance, and power system engineering across Argentina.",
      ...
      <section style={{ backgroundColor: "#ffffff" }} className="py-20 px-4">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            ...
            Argentina facility compliant with AEA 90364 and IRAM 2281. Our
