...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Hungary",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and MSZ HD 60364 compliance for Hungary facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/hu/blogs/",
    languages: {
      "en-HU": "https://carelabz.com/hu/blogs/",
      "x-default": "https://carelabz.com/hu/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Hungary",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Hungary.",
    url: "https://carelabz.com/hu/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-HU", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function HUBlogIndexPage() {
  const allPosts = await getBlogPosts("hu");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/hu/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Hungary",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Hungary.",
      "en-HU"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/hu/" },
      { name: "Blog", url: "https://carelabz.com/hu/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of MSZ HD 60364, MSZ HD 60364, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Hungary
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Hungary facility meet
              MSZ HD 60364 and MSZ HD 60364 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/hu/services/arc-flash-study/"
