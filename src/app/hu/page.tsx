...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("hu");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Hungary",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, MSZ HD 60364 compliance, short circuit analysis, and power system engineering across Hungary.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/hu/",
      languages: {
        "en-HU": "https://carelabz.com/hu/",
        "x-default": "https://carelabz.com/hu/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Hungary — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, MSZ HD 60364 compliance, and power system engineering across Hungary.",
      url: "https://carelabz.com/hu/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_HU",
    },
...
export default async function HUHomePage() {
  const page = await getHomePage("hu");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Hungary",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Hungary standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
