...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Poland",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and PN-HD 60364 compliance for Poland facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/pl/blogs/",
    languages: {
      "en-PL": "https://carelabz.com/pl/blogs/",
      "x-default": "https://carelabz.com/pl/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Poland",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Poland.",
    url: "https://carelabz.com/pl/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-PL", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function PLBlogIndexPage() {
  const allPosts = await getBlogPosts("pl");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/pl/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Poland",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Poland.",
      "en-PL"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/pl/" },
      { name: "Blog", url: "https://carelabz.com/pl/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of PN-HD 60364, PN-HD 60364, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Poland
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Poland facility meet
              PN-HD 60364 and PN-HD 60364 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/pl/services/arc-flash-study/"
