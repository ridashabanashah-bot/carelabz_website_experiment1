...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("pl");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Poland",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, PN-HD 60364 compliance, short circuit analysis, and power system engineering across Poland.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/pl/",
      languages: {
        "en-PL": "https://carelabz.com/pl/",
        "x-default": "https://carelabz.com/pl/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Poland — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, PN-HD 60364 compliance, and power system engineering across Poland.",
      url: "https://carelabz.com/pl/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_PL",
    },
...
export default async function PLHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Poland",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Poland standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
