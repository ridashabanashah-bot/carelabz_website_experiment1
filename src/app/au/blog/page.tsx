...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Australia",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and AS/NZS 3000 compliance for Australia facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/au/blog/",
    languages: {
      "en-AU": "https://carelabz.com/au/blog/",
      "x-default": "https://carelabz.com/au/blog/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Australia",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Australia.",
    url: "https://carelabz.com/au/blog/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function AUBlogIndexPage() {
  const allPosts = await getBlogPosts("au");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/au/blog/",
      "Electrical Safety Blog & Industry Insights | Carelabs Australia",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Australia.",
      "en-AU"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/au/" },
      { name: "Blog", url: "https://carelabz.com/au/blog/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              ...
              Expert knowledge from the Carelabs engineering team to help Australian
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Australia facility meet
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/au/services/arc-flash-study/"
