...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("au");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Australia",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, AS/NZS 3000 compliance, short circuit analysis, and power system engineering across Australia.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/au/",
      languages: {
        "en-AU": "https://carelabz.com/au/",
        "x-default": "https://carelabz.com/au/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Australia — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, AS/NZS 3000 compliance, and power system engineering across Australia.",
      url: "https://carelabz.com/au/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_AU",
    },
...
export default async function AUHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Australia",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Australian standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
