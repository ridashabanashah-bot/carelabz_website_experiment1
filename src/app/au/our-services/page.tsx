...
export const metadata: Metadata = {
  title: "Electrical Safety Services Australia | Carelabs",
  description:
    "Discover Carelabs' Australian electrical safety services — arc flash studies, short circuit analysis, load flow analysis, and relay coordination aligned with AS/NZS 3000 and the AS/NZS 3000.",
  alternates: {
    canonical: "https://carelabz.com/au/our-services/",
    languages: {
      "en-AU": "https://carelabz.com/au/our-services/",
      "x-default": "https://carelabz.com/au/our-services/",
    },
  },
  openGraph: {
    title: "Power System Engineering Services in Australia | Carelabs",
    description:
      "Professional electrical safety services including arc flash studies, short circuit analysis, and power system engineering across Australia.",
    url: "https://carelabz.com/au/our-services/",
    siteName: "Carelabs",
    type: "website",
    locale: "en_AU",
  },
...
function getServiceHref(service: ServicePage): string {
  ...
  return `/au/services/${urlSlug}/`;
}

export default async function AUServicesIndexPage() {
  const services = await getServicesByRegion("au");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/au/our-services/",
      "Power System Engineering Services in Australia | Carelabs",
      "Professional electrical safety services including arc flash studies, short circuit analysis, and power system engineering across Australia.",
      "en-AU"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/au/" },
      { name: "Services", url: "https://carelabz.com/au/our-services/" },
    ]),
  ]);
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-sm font-semibold uppercase tracking-widest text-orange-400 mb-3">
              Australian Electrical Engineering
            </p>
            ...
            <p className="text-lg text-[#374151] leading-relaxed">
              ...
              your operations running smoothly — delivered by certified engineers across Australia.
            </p>
          </div>
        </div>
      </section>
