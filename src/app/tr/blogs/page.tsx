...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Turkey",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and TS HD 60364 compliance for Turkey facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/tr/blogs/",
    languages: {
      "en-TR": "https://carelabz.com/tr/blogs/",
      "x-default": "https://carelabz.com/tr/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Turkey",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Turkey.",
    url: "https://carelabz.com/tr/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-TR", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function TRBlogIndexPage() {
  const allPosts = await getBlogPosts("tr");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/tr/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Turkey",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Turkey.",
      "en-TR"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/tr/" },
      { name: "Blog", url: "https://carelabz.com/tr/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of TS HD 60364, TS HD 60364, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Turkey
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Turkey facility meet
              TS HD 60364 and TS HD 60364 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/tr/services/arc-flash-study/"
