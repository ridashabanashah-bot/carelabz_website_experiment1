...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs India",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and CEA Regulations 2010 compliance for India facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/in/our-blogs/",
    languages: {
      "en-IN": "https://carelabz.com/in/our-blogs/",
      "x-default": "https://carelabz.com/in/our-blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs India",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in India.",
    url: "https://carelabz.com/in/our-blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function INBlogIndexPage() {
  const allPosts = await getBlogPosts("in");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/in/our-blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs India",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in India.",
      "en-IN"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/in/" },
      { name: "Blog", url: "https://carelabz.com/in/our-blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of CEA Regulations 2010, CEA Regulations, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Indian
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your India facility meet
              CEA Regulations 2010 and CEA Regulations requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/in/services/arc-flash-study/"
