...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("in");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | India",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, CEA Regulations 2010 compliance, short circuit analysis, and power system engineering across India.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/in/",
      languages: {
        "en-IN": "https://carelabz.com/in/",
        "x-default": "https://carelabz.com/in/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs India — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, CEA Regulations 2010 compliance, and power system engineering across India.",
      url: "https://carelabz.com/in/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_IN",
    },
...
export default async function INHomePage() {
  const page = await getHomePage("in");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, India",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Indian standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
