...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("be");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Belgium",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, AREI/RGIE compliance, short circuit analysis, and power system engineering across Belgium.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/be/",
      languages: {
        "en-BE": "https://carelabz.com/be/",
        "x-default": "https://carelabz.com/be/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Belgium — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, AREI/RGIE compliance, and power system engineering across Belgium.",
      url: "https://carelabz.com/be/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_BE",
    },
...
export default async function BEHomePage() {
  const page = await getHomePage("be");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Belgium",
    },
  };
