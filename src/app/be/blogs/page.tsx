...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Belgium",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and AREI/RGIE compliance for Belgium facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/be/blogs/",
    languages: {
      "en-BE": "https://carelabz.com/be/blogs/",
      "x-default": "https://carelabz.com/be/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Belgium",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Belgium.",
    url: "https://carelabz.com/be/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function BEBlogIndexPage() {
  const allPosts = await getBlogPosts("be");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/be/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Belgium",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Belgium.",
      "en-BE"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/be/" },
      { name: "Blog", url: "https://carelabz.com/be/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of AREI/RGIE, AREI/RGIE, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Belgium
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Belgium facility meet
              AREI/RGIE and AREI/RGIE requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/be/services/arc-flash-study/"
