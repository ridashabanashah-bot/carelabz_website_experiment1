...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Mexico",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and NOM-029-STPS-2011 compliance for Mexico facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/mx/blogs/",
    languages: {
      "en-MX": "https://carelabz.com/mx/blogs/",
      "x-default": "https://carelabz.com/mx/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Mexico",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Mexico.",
    url: "https://carelabz.com/mx/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-MX", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function MXBlogIndexPage() {
  const allPosts = await getBlogPosts("mx");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/mx/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Mexico",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Mexico.",
      "en-MX"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/mx/" },
      { name: "Blog", url: "https://carelabz.com/mx/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of NOM-029-STPS-2011, Mexican Electrical Code (NOM-001-SEDE), and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Mexico
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Mexico facility meet
              NOM-029-STPS-2011 and Mexican Electrical Code (NOM-001-SEDE) requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/mx/services/arc-flash-study/"
