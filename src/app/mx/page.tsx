...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("mx");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Mexico",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, NOM-029-STPS-2011 compliance, short circuit analysis, and power system engineering across Mexico.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/mx/",
      languages: {
        "en-MX": "https://carelabz.com/mx/",
        "x-default": "https://carelabz.com/mx/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Mexico — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, NOM-029-STPS-2011 compliance, and power system engineering across Mexico.",
      url: "https://carelabz.com/mx/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_MX",
    },
...
export default async function MXHomePage() {
  const page = await getHomePage("mx");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Mexico",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Mexico standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
