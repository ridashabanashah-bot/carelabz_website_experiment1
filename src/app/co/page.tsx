...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("co");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Colombia",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, RETIE compliance, short circuit analysis, and power system engineering across Colombia.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/co/",
      languages: {
        "en-CO": "https://carelabz.com/co/",
        "x-default": "https://carelabz.com/co/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Colombia — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, RETIE compliance, and power system engineering across Colombia.",
      url: "https://carelabz.com/co/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_CO",
    },
...
export default async function COHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Colombia",
    },
  };
