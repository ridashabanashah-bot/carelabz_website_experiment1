...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title:
      page?.metaTitle ??
      "Carelabs — Electrical Safety & Power System Studies | Colombia",
    description:
    ...
    openGraph: {
      title:
        page?.metaTitle ??
        "Carelabs Colombia — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ??
        "IEEE 1584 arc flash studies, RETIE compliance, and power system engineering across Colombia.",
      ...
      <section style={{ backgroundColor: "#ffffff" }} className="py-20 px-4">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            ...
            Colombia facility compliant with RETIE and NTC 2050. Our
