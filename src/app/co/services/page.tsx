...
export const metadata: Metadata = {
  ...
  description:
    "Discover Carelabs' Colombian electrical safety services — arc flash studies, short circuit analysis, load flow analysis, and relay coordination aligned with RETIE and the NTC 2050.",
  alternates: {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-sm font-semibold uppercase tracking-widest text-orange-400 mb-3">
              Colombian Electrical Engineering
            </p>
            ...
            <p className="text-lg text-[#374151] leading-relaxed">
              ...
              facilities compliant with RETIE, your workers protected, and
              your operations running smoothly — delivered by certified engineers across Colombia.
            </p>
          </div>
        </div>
      </section>
