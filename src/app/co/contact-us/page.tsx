...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        page?.metaDescription ??
        "Get in touch for a free consultation on electrical safety services in Colombia.",
...
export default async function COContactPage() {
  ...
  const subtext =
    page?.heroSubtext ??
    "Have a question or ready to start a project? Our Colombia team is here to help.";
      ...
      <main id="main-content">
        ...
        >
          <div className="relative mx-auto max-w-4xl text-center">
            ...
            >
              Our Colombia team is available to respond to emergency compliance
