...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getAboutPage("co");
  return {
    title: page?.metaTitle ?? "About Carelabs | Colombian Electrical Safety Experts",
    description:
      page?.metaDescription ??
      "Learn about Carelabs — our mission, values, and the team dedicated to electrical safety testing and RETIE compliance across Colombia.",
    alternates: {
      canonical: "https://carelabz.com/co/about-us/",
      languages: {
        "en-CO": "https://carelabz.com/co/about-us/",
        "x-default": "https://carelabz.com/co/about-us/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "About Carelabs — Power System Consultants Colombia",
      description:
        page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Colombia.",
      url: "https://carelabz.com/co/about-us/",
      siteName: "Carelabs",
      type: "website",
    },
    twitter: {
...
export default async function COAboutPage() {
  ...
  const subtext =
    page?.heroSubtext ??
    "Carelabs is a trusted partner for electrical safety testing, calibration, inspection, and certification services across Colombia.";
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/co/about-us/",
      page?.metaTitle ?? "About Carelabs — Power System Consultants Colombia",
      page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Colombia.",
      "en-CO"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/co/" },
      { name: "About", url: "https://carelabz.com/co/about-us/" },
    ]),
  ]);
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              {page?.ctaBannerHeading ?? "Partner with Carelabs Colombia"}
            </h2>
            {page?.ctaBannerSubtext ? (
              <p className="text-white/70 text-lg mb-8">{page.ctaBannerSubtext}</p>
            ) : (
              <p className="text-white/70 text-lg mb-8">
                Ready to elevate your safety standards? Talk to our Colombian experts today.
              </p>
            )}
            <Link
              href={page?.ctaBannerPrimaryHref ?? "/co/contact-us/"}
