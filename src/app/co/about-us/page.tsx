...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title:
      page?.metaTitle ?? "About Carelabs | Colombia Electrical Safety Experts",
    description:
    ...
    openGraph: {
      ...
      description:
        page?.metaDescription ??
        "Carelabs is a leading electrical safety engineering firm in Colombia.",
          ...
          <div className="relative mx-auto max-w-4xl text-center">
            ...
            >
              {page?.ctaBannerSubtext ??
                "Ready to elevate your safety standards? Talk to our Colombia experts today."}
            </p>
            <Link
