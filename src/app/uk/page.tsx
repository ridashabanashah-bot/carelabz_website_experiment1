...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("uk");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | United Kingdom",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, BS 7671 compliance, short circuit analysis, and power system engineering across United Kingdom.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/uk/",
      languages: {
        "en-GB": "https://carelabz.com/uk/",
        "x-default": "https://carelabz.com/uk/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs United Kingdom — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, BS 7671 compliance, and power system engineering across United Kingdom.",
      url: "https://carelabz.com/uk/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_GB",
    },
...
export default async function UKHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, United Kingdom",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with United Kingdom standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
