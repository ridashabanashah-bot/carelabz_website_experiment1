...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getAboutPage("uk");
  return {
    title: page?.metaTitle ?? "About Carelabs | United Kingdom Electrical Safety Experts",
    description:
      page?.metaDescription ??
      "Learn about Carelabs — our mission, values, and the team dedicated to electrical safety testing and BS 7671 compliance across United Kingdom.",
    alternates: {
      canonical: "https://carelabz.com/uk/about-us/",
      languages: {
        "en-GB": "https://carelabz.com/uk/about-us/",
        "x-default": "https://carelabz.com/uk/about-us/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "About Carelabs — Power System Consultants United Kingdom",
      description:
        page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in United Kingdom.",
      url: "https://carelabz.com/uk/about-us/",
      siteName: "Carelabs",
      type: "website",
    },
    twitter: {
...
export default async function UKAboutPage() {
  ...
  const subtext =
    page?.heroSubtext ??
    "Carelabs is a trusted partner for electrical safety testing, calibration, inspection, and certification services across United Kingdom.";
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/uk/about-us/",
      page?.metaTitle ?? "About Carelabs — Power System Consultants United Kingdom",
      page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in United Kingdom.",
      "en-GB"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/uk/" },
      { name: "About", url: "https://carelabz.com/uk/about-us/" },
    ]),
  ]);
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              {page?.ctaBannerHeading ?? "Partner with Carelabs United Kingdom"}
            </h2>
            {page?.ctaBannerSubtext ? (
              <p className="text-white/70 text-lg mb-8">{page.ctaBannerSubtext}</p>
            ) : (
              <p className="text-white/70 text-lg mb-8">
                Ready to elevate your safety standards? Talk to our United Kingdom experts today.
              </p>
            )}
            <Link
              href={page?.ctaBannerPrimaryHref ?? "/uk/contact-us/"}
