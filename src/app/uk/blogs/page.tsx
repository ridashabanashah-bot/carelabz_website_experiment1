...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs United Kingdom",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and BS 7671 compliance for United Kingdom facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/uk/blogs/",
    languages: {
      "en-GB": "https://carelabz.com/uk/blogs/",
      "x-default": "https://carelabz.com/uk/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs United Kingdom",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in United Kingdom.",
    url: "https://carelabz.com/uk/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function UKBlogIndexPage() {
  const allPosts = await getBlogPosts("uk");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/uk/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs United Kingdom",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in United Kingdom.",
      "en-GB"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/uk/" },
      { name: "Blog", url: "https://carelabz.com/uk/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of BS 7671, IET Wiring Regulations, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help United Kingdom
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your United Kingdom facility meet
              BS 7671 and IET Wiring Regulations requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/uk/services/arc-flash-study/"
