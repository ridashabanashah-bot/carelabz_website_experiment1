...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("za");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | South Africa",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, SANS 10142 compliance, short circuit analysis, and power system engineering across South Africa.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/za/",
      languages: {
        "en-ZA": "https://carelabz.com/za/",
        "x-default": "https://carelabz.com/za/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs South Africa — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, SANS 10142 compliance, and power system engineering across South Africa.",
      url: "https://carelabz.com/za/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_ZA",
    },
...
export default async function ZAHomePage() {
  const page = await getHomePage("za");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, South Africa",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with South African standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
