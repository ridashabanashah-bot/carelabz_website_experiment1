...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs South Africa",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and SANS 10142 compliance for South Africa facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/za/blogs/",
    languages: {
      "en-ZA": "https://carelabz.com/za/blogs/",
      "x-default": "https://carelabz.com/za/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs South Africa",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in South Africa.",
    url: "https://carelabz.com/za/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function ZABlogIndexPage() {
  const allPosts = await getBlogPosts("za");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/za/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs South Africa",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in South Africa.",
      "en-ZA"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/za/" },
      { name: "Blog", url: "https://carelabz.com/za/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of SANS 10142, SANS 10142, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help South African
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your South Africa facility meet
              SANS 10142 and SANS 10142 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/za/services/arc-flash-study/"
