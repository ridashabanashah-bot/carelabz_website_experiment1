...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("kr");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | South Korea",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, KEC compliance, short circuit analysis, and power system engineering across South Korea.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/kr/",
      languages: {
        "en-KR": "https://carelabz.com/kr/",
        "x-default": "https://carelabz.com/kr/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs South Korea — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, KEC compliance, and power system engineering across South Korea.",
      url: "https://carelabz.com/kr/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_KR",
    },
...
export default async function KRHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, South Korea",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with South Korean standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
