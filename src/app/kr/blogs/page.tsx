...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs South Korea",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and KEC compliance for South Korea facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/kr/blogs/",
    languages: {
      "en-KR": "https://carelabz.com/kr/blogs/",
      "x-default": "https://carelabz.com/kr/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs South Korea",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in South Korea.",
    url: "https://carelabz.com/kr/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-KR", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function KRBlogIndexPage() {
  const allPosts = await getBlogPosts("kr");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/kr/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs South Korea",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in South Korea.",
      "en-KR"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/kr/" },
      { name: "Blog", url: "https://carelabz.com/kr/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of KEC, KEC, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help South Korean
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your South Korea facility meet
              KEC and KEC requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/kr/services/arc-flash-study/"
