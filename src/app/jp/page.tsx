...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("jp");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Japan",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, JEAC 8001 compliance, short circuit analysis, and power system engineering across Japan.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/jp/",
      languages: {
        "en-JP": "https://carelabz.com/jp/",
        "x-default": "https://carelabz.com/jp/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Japan — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, JEAC 8001 compliance, and power system engineering across Japan.",
      url: "https://carelabz.com/jp/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_JP",
    },
...
export default async function JPHomePage() {
  const page = await getHomePage("jp");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Japan",
    },
  };
