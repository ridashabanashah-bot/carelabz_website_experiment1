...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Japan",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and JEAC 8001 compliance for Japan facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/jp/blogs/",
    languages: {
      "en-JP": "https://carelabz.com/jp/blogs/",
      "x-default": "https://carelabz.com/jp/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Japan",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Japan.",
    url: "https://carelabz.com/jp/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-JP", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function JPBlogIndexPage() {
  const allPosts = await getBlogPosts("jp");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/jp/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Japan",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Japan.",
      "en-JP"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/jp/" },
      { name: "Blog", url: "https://carelabz.com/jp/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of JEAC 8001, JEAC 8001, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Japan
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Japan facility meet
              JEAC 8001 and JEAC 8001 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/jp/services/arc-flash-study/"
