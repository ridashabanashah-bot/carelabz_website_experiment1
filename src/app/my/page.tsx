...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("my");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Malaysia",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, MS IEC 60364 compliance, short circuit analysis, and power system engineering across Malaysia.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/my/",
      languages: {
        "en-MY": "https://carelabz.com/my/",
        "x-default": "https://carelabz.com/my/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Malaysia — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, MS IEC 60364 compliance, and power system engineering across Malaysia.",
      url: "https://carelabz.com/my/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_MY",
    },
...
export default async function MYHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Malaysia",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Malaysian standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
