...
export const metadata: Metadata = {
  title: "Electrical Safety Services Malaysia | Carelabs",
  description:
    "Discover Carelabs' Malaysian electrical safety services — arc flash studies, short circuit analysis, load flow analysis, and relay coordination aligned with MS IEC 60364 and the MS IEC 60364.",
  alternates: {
    canonical: "https://carelabz.com/my/our-services/",
    languages: {
      "en-MY": "https://carelabz.com/my/our-services/",
      "x-default": "https://carelabz.com/my/our-services/",
    },
  },
  openGraph: {
    title: "Power System Engineering Services in Malaysia | Carelabs",
    description:
      "Professional electrical safety services including arc flash studies, short circuit analysis, and power system engineering across Malaysia.",
    url: "https://carelabz.com/my/our-services/",
    siteName: "Carelabs",
    type: "website",
    locale: "en_MY",
  },
...
function getServiceHref(service: ServicePage): string {
  ...
  return `/my/services/${urlSlug}/`;
}

export default async function MYServicesIndexPage() {
  const services = await getServicesByRegion("my");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/my/our-services/",
      "Power System Engineering Services in Malaysia | Carelabs",
      "Professional electrical safety services including arc flash studies, short circuit analysis, and power system engineering across Malaysia.",
      "en-MY"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/my/" },
      { name: "Services", url: "https://carelabz.com/my/our-services/" },
    ]),
  ]);
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-sm font-semibold uppercase tracking-widest text-orange-400 mb-3">
              Malaysian Electrical Engineering
            </p>
            ...
            <p className="text-lg text-[#374151] leading-relaxed">
              ...
              facilities compliant with MS IEC 60364, your workers protected, and
              your operations running smoothly — delivered by certified engineers across Malaysia.
            </p>
          </div>
        </div>
      </section>
