...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Malaysia",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and MS IEC 60364 compliance for Malaysia facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/my/blogs/",
    languages: {
      "en-MY": "https://carelabz.com/my/blogs/",
      "x-default": "https://carelabz.com/my/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Malaysia",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Malaysia.",
    url: "https://carelabz.com/my/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function MYBlogIndexPage() {
  const allPosts = await getBlogPosts("my");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/my/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Malaysia",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Malaysia.",
      "en-MY"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/my/" },
      { name: "Blog", url: "https://carelabz.com/my/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of MS IEC 60364, MS IEC 60364, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Malaysian
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Malaysia facility meet
              MS IEC 60364 and MS IEC 60364 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/my/services/arc-flash-study/"
