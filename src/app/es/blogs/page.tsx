...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Spain",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and REBT compliance for Spain facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/es/blogs/",
    languages: {
      "en-ES": "https://carelabz.com/es/blogs/",
      "x-default": "https://carelabz.com/es/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Spain",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Spain.",
    url: "https://carelabz.com/es/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-ES", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function ESBlogIndexPage() {
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/es/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Spain",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Spain.",
      "en-ES"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/es/" },
      { name: "Blog", url: "https://carelabz.com/es/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of REBT, REBT, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Spain
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Spain facility meet
              REBT and REBT requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/es/services/arc-flash-study/"
