...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("es");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Spain",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, REBT compliance, short circuit analysis, and power system engineering across Spain.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/es/",
      languages: {
        "en-ES": "https://carelabz.com/es/",
        "x-default": "https://carelabz.com/es/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Spain — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, REBT compliance, and power system engineering across Spain.",
      url: "https://carelabz.com/es/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_ES",
    },
...
export default async function ESHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Spain",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Spain standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
