...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getAboutPage("es");
  return {
    title: page?.metaTitle ?? "About Carelabs | Spain Electrical Safety Experts",
    description:
      page?.metaDescription ??
      "Learn about Carelabs — our mission, values, and the team dedicated to electrical safety testing and REBT compliance across Spain.",
    alternates: {
      canonical: "https://carelabz.com/es/about-us/",
      languages: {
        "en-ES": "https://carelabz.com/es/about-us/",
        "x-default": "https://carelabz.com/es/about-us/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "About Carelabs — Power System Consultants Spain",
      description:
        page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Spain.",
      url: "https://carelabz.com/es/about-us/",
      siteName: "Carelabs",
      type: "website",
    },
    twitter: {
...
export default async function ESAboutPage() {
  ...
  const subtext =
    page?.heroSubtext ??
    "Carelabs is a trusted partner for electrical safety testing, calibration, inspection, and certification services across Spain.";
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/es/about-us/",
      page?.metaTitle ?? "About Carelabs — Power System Consultants Spain",
      page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Spain.",
      "en-ES"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/es/" },
      { name: "About", url: "https://carelabz.com/es/about-us/" },
    ]),
  ]);
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              {page?.ctaBannerHeading ?? "Partner with Carelabs Spain"}
            </h2>
            {page?.ctaBannerSubtext ? (
              <p className="text-white/70 text-lg mb-8">{page.ctaBannerSubtext}</p>
            ) : (
              <p className="text-white/70 text-lg mb-8">
                Ready to elevate your safety standards? Talk to our Spain experts today.
              </p>
            )}
            <Link
              href={page?.ctaBannerPrimaryHref ?? "/es/contact-us/"}
