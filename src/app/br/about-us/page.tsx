...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: "https://carelabz.com/br/about-us/",
      languages: {
        "en-BR": "https://carelabz.com/br/about-us/",
        "x-default": "https://carelabz.com/br/about-us/",
      },
    },
    openGraph: {
...
export default async function BRAboutPage() {
  ...
  const jsonLd = buildJsonLd([
    ...
    getBreadcrumbSchema([
      ...
      { name: "About", url: "https://carelabz.com/br/about-us/" },
    ]),
  ]);
