...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("at");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Austria",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, ÖVE/ÖNORM E 8001 compliance, short circuit analysis, and power system engineering across Austria.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/at/",
      languages: {
        "en-AT": "https://carelabz.com/at/",
        "x-default": "https://carelabz.com/at/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Austria — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, ÖVE/ÖNORM E 8001 compliance, and power system engineering across Austria.",
      url: "https://carelabz.com/at/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_AT",
    },
...
export default async function ATHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Austria",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Austrian standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
