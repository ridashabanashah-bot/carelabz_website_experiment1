...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Austria",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and ÖVE/ÖNORM E 8001 compliance for Austria facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/at/blogs/",
    languages: {
      "en-AT": "https://carelabz.com/at/blogs/",
      "x-default": "https://carelabz.com/at/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Austria",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Austria.",
    url: "https://carelabz.com/at/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-AT", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function ATBlogIndexPage() {
  const allPosts = await getBlogPosts("at");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/at/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Austria",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Austria.",
      "en-AT"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/at/" },
      { name: "Blog", url: "https://carelabz.com/at/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of ÖVE/ÖNORM E 8001, ÖVE/ÖNORM E 8001, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Austrian
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Austria facility meet
              ÖVE/ÖNORM E 8001 and ÖVE/ÖNORM E 8001 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/at/services/arc-flash-study/"
