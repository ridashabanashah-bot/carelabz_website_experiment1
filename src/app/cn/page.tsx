...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("cn");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | China",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, GB 50054 compliance, short circuit analysis, and power system engineering across China.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/cn/",
      languages: {
        "en-CN": "https://carelabz.com/cn/",
        "x-default": "https://carelabz.com/cn/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs China — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, GB 50054 compliance, and power system engineering across China.",
      url: "https://carelabz.com/cn/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_CN",
    },
...
export default async function CNHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, China",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Chinan standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
