...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs China",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and GB 50054 compliance for China facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/cn/blogs/",
    languages: {
      "en-CN": "https://carelabz.com/cn/blogs/",
      "x-default": "https://carelabz.com/cn/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs China",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in China.",
    url: "https://carelabz.com/cn/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function CNBlogIndexPage() {
  const allPosts = await getBlogPosts("cn");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/cn/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs China",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in China.",
      "en-CN"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/cn/" },
      { name: "Blog", url: "https://carelabz.com/cn/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of GB 50054, GB 50054, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Chinan
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your China facility meet
              GB 50054 and GB 50054 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/cn/services/arc-flash-study/"
