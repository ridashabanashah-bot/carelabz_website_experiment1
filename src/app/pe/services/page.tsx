...
export const metadata: Metadata = {
  ...
  description:
    "Discover Carelabs' Peru electrical safety services — arc flash studies, short circuit analysis, load flow analysis, and relay coordination aligned with RM 111-2013-MEM and CNE.",
  alternates: {
...
function getServiceHref(service: ServicePage): string {
  ...
  const urlSlug = slug.endsWith("-pe") ? slug.slice(0, -3) : slug;
  return `/pe/${urlSlug}/`;
}
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-8 lg:px-16">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              ...
              facilities compliant with RM 111-2013-MEM, your workers protected, and your
