...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Germany",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and DIN VDE 0100 compliance for Germany facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/de/blogs/",
    languages: {
      "en-DE": "https://carelabz.com/de/blogs/",
      "x-default": "https://carelabz.com/de/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Germany",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Germany.",
    url: "https://carelabz.com/de/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function DEBlogIndexPage() {
  const allPosts = await getBlogPosts("de");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/de/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Germany",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Germany.",
      "en-DE"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/de/" },
      { name: "Blog", url: "https://carelabz.com/de/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of DIN VDE 0100, DIN VDE 0100, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Germany
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Germany facility meet
              DIN VDE 0100 and DIN VDE 0100 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/de/services/arc-flash-study/"
