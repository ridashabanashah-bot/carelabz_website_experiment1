...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("de");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Germany",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, DIN VDE 0100 compliance, short circuit analysis, and power system engineering across Germany.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/de/",
      languages: {
        "en-DE": "https://carelabz.com/de/",
        "x-default": "https://carelabz.com/de/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Germany — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, DIN VDE 0100 compliance, and power system engineering across Germany.",
      url: "https://carelabz.com/de/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_DE",
    },
...
export default async function DEHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Germany",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Germany standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
