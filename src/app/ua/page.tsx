...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("ua");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Ukraine",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, PUE compliance, short circuit analysis, and power system engineering across Ukraine.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/ua/",
      languages: {
        "en-UA": "https://carelabz.com/ua/",
        "x-default": "https://carelabz.com/ua/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Ukraine — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, PUE compliance, and power system engineering across Ukraine.",
      url: "https://carelabz.com/ua/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_UA",
    },
...
export default async function UAHomePage() {
  const page = await getHomePage("ua");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Ukraine",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Ukraine standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
