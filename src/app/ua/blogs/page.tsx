...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Ukraine",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and PUE compliance for Ukraine facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/ua/blogs/",
    languages: {
      "en-UA": "https://carelabz.com/ua/blogs/",
      "x-default": "https://carelabz.com/ua/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Ukraine",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Ukraine.",
    url: "https://carelabz.com/ua/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-UA", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function UABlogIndexPage() {
  const allPosts = await getBlogPosts("ua");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/ua/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Ukraine",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Ukraine.",
      "en-UA"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/ua/" },
      { name: "Blog", url: "https://carelabz.com/ua/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of PUE, PUE, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Ukraine
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Ukraine facility meet
              PUE and PUE requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/ua/services/arc-flash-study/"
