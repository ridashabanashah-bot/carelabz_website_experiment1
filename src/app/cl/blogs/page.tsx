...
export const metadata: Metadata = {
  title:
    "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Chile",
  description:
      ...
      <main id="main-content">
        ...
        >
          ...
          <div className="relative mx-auto max-w-4xl px-4 sm:px-8 text-center">
            ...
            >
              Stay ahead of NCh Elec. 4/2003, NSEG 5 En. 71, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help
              Chile facilities stay safe and compliant.
            </p>
          </div>
        </section>
        ...
        >
          <div className="relative mx-auto max-w-4xl text-center">
            ...
            >
              ...
              NCh Elec. 4/2003 and NSEG 5 En. 71 requirements. Get a free consultation
              today.
            </p>
