...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: page?.metaTitle ?? "Contact Carelabs — Get a Free Consultation Chile",
      description:
        page?.metaDescription ?? "Get in touch for a free consultation on electrical safety services in Chile.",
...
export default async function CLContactPage() {
  ...
  // On the Chile contact page the banner must always say Chile
  // regardless of the visitor's IP — the services ARE in Chile.
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8">
              Our Chile team is available to respond to emergency compliance and
