...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title:
      page?.metaTitle ??
      "Carelabs — Electrical Safety & Power System Studies | Chile",
    description:
    ...
    openGraph: {
      title:
        page?.metaTitle ??
        "Carelabs Chile — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ??
        "IEEE 1584 arc flash studies, NCh Elec. 4/2003 compliance, and power system engineering across Chile.",
      ...
      <section style={{ backgroundColor: "#ffffff" }} className="py-20 px-4">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            ...
            Chile facility compliant with NCh Elec. 4/2003 and NSEG 5 En. 71. Our
