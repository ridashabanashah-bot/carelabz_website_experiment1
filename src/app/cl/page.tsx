...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("cl");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Chile",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, NCh Elec. 4/2003 compliance, short circuit analysis, and power system engineering across Chile.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/cl/",
      languages: {
        "en-CL": "https://carelabz.com/cl/",
        "x-default": "https://carelabz.com/cl/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Chile — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, NCh Elec. 4/2003 compliance, and power system engineering across Chile.",
      url: "https://carelabz.com/cl/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_CL",
    },
...
export default async function CLHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Chile",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Chile standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
