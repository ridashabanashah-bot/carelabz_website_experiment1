...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getAboutPage("cl");
  return {
    title: page?.metaTitle ?? "About Carelabs | Chile Electrical Safety Experts",
    description:
      page?.metaDescription ??
      "Learn about Carelabs — our mission, values, and the team dedicated to electrical safety testing and NCh Elec. 4/2003 compliance across Chile.",
    alternates: {
      canonical: "https://carelabz.com/cl/about-us/",
      languages: {
        "en-CL": "https://carelabz.com/cl/about-us/",
        "x-default": "https://carelabz.com/cl/about-us/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "About Carelabs — Power System Consultants Chile",
      description:
        page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Chile.",
      url: "https://carelabz.com/cl/about-us/",
      siteName: "Carelabs",
      type: "website",
    },
    twitter: {
...
export default async function CLAboutPage() {
  ...
  const subtext =
    page?.heroSubtext ??
    "Carelabs is a trusted partner for electrical safety testing, calibration, inspection, and certification services across Chile.";
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/cl/about-us/",
      page?.metaTitle ?? "About Carelabs — Power System Consultants Chile",
      page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Chile.",
      "en-CL"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/cl/" },
      { name: "About", url: "https://carelabz.com/cl/about-us/" },
    ]),
  ]);
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              {page?.ctaBannerHeading ?? "Partner with Carelabs Chile"}
            </h2>
            {page?.ctaBannerSubtext ? (
              <p className="text-white/70 text-lg mb-8">{page.ctaBannerSubtext}</p>
            ) : (
              <p className="text-white/70 text-lg mb-8">
                Ready to elevate your safety standards? Talk to our Chile experts today.
              </p>
            )}
            <Link
              href={page?.ctaBannerPrimaryHref ?? "/cl/contact-us/"}
