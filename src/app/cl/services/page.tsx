...
export const metadata: Metadata = {
  ...
  description:
    "Discover Carelabs' Chile electrical safety services — arc flash studies, short circuit analysis, load flow analysis, and relay coordination aligned with NCh Elec. 4/2003 and the NCh Elec. 4/2003.",
  alternates: {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-[#374151] leading-relaxed">
              ...
              facilities compliant with NCh Elec. 4/2003, your workers protected, and
              your operations running smoothly — delivered by certified engineers across Chile.
            </p>
          </div>
        </div>
      </section>
