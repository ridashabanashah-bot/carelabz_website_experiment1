          ...
          <div>
            ...
            <ul className="space-y-3">
              {AE_CATEGORIES_ORDER.map((cat) => (
                <li key={cat}>
                  <Link
                    href={`/${config.cc}/services/category/${CATEGORY_TO_SLUG[cat]}/`}
              ...
              <li className="pt-1">
                <Link
                  href={`/${config.cc}/services/`}
                  className="text-xs uppercase tracking-[0.15em] text-[#F15C30] transition-colors duration-300 hover:text-[#d44a22]"
                >
                  All services →
                </Link>
              </li>
