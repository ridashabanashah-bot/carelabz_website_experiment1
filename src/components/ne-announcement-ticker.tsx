...
export function NEAnnouncementTicker({
  ...
  return (
    <div className="bg-[#1A3650] overflow-hidden py-1.5 border-b border-white/5">
      <div className="animate-marquee whitespace-nowrap">
        {Array.from({ length: 3 }).map((_, i) => (
          <span key={i} className="inline-block mx-6">
            <span className="font-ne-nav text-xs uppercase tracking-[0.18em] text-white/60">
              Carelabs
            </span>
            <span className="text-orange-500 mx-3">·</span>
            <span className="font-ne-nav text-xs uppercase tracking-[0.18em] text-white/40">
